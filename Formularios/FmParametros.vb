...
Public Class FmParametros
    ...
    Dim Conexio2 As Conexion_Dr = New Conexion_Dr()

    Private Sub FmParametros_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Me.Text = "Parametros"
        Conexio2.LlenarCombo("Select PAR_DESCRIP1,PAR_STATUS  from CRM_PARAMETR where PAR_TIPOPARA = 'STATU' and PAR_STATUS = 'ACTIVO'", CmbStatus)
        MostraDatos()
        Librerias.CambiaColorDgv(DgvDatos)
    End Sub
    ...
    Private Sub MostraDatos()
        ...
        Me.DgvDatos.Columns(2).Width = 170
        Me.DgvDatos.Columns(3).Width = 170
    End Sub
    ...
    Private Sub Tabulador(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TxtTipo.KeyPress, TxtId.KeyPress, CmbStatus.KeyPress, TxtDescripcion1.KeyPress, TxtDescripcion2.KeyPress, TxtDescripcion3.KeyPress, TxtFecha1.KeyPress, TxtFecha2.KeyPress, TxtFecha3.KeyPress
